#!/usr/bin/env python3
"""
Analysis Configuration for Feature Analysis Pipeline

This module defines the CalculatedFeatures configuration dictionary that specifies
which behavioral features to extract and how to process them.

The configuration is parameterized by fps and pixels_per_cm, allowing the same
feature definitions to be used across different video/setup configurations.
...
Usage:
    ...
    features_config = build_calculated_features(fps=29.595, pixels_per_cm=32)
"""

import numpy as np


def build_calculated_features(fps: float, pixels_per_cm: float) -> dict:
    """
    Build the CalculatedFeatures configuration dictionary.
    ...
    calculated_features = {
        ...
        "Midline angle average (during loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "relative_midline_angle",
                "window": {
                    "frame_start_point": "loomtime",
                    "frame_end_offset": int(7.5 * fps)
                },
        ...
        "Midline angle average (start loom - nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "relative_midline_angle",
                "window": {
        ...
        "Midline angle average (10s before loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "relative_midline_angle",
                "window": {
        ...
        "Midline angle average (10s after nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "relative_midline_angle",
                "window": {
                    "frame_start_point": "latency",
                    "frame_end_point": "latency",
                    "frame_end_offset": int(10 * fps)
                },
                "crop_to_both": False
            },
            "post": None,
        ...
        "Midline angle average (0.2 seconds after loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "relative_midline_angle",
                "window": {
        ...
        # =====================================================================
        # NOSE-TO-NOSE DISTANCE FEATURES (Social/Pair)
        # =====================================================================

        "Nose to nose average (during loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_to_nose_distance",
                "window": {
                    "frame_start_point": "loomtime",
                    "frame_end_offset": int(7.5 * fps)
                },
        ...
        "Nose to nose average (start loom - nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_to_nose_distance",
                "window": {
        ...
        "Nose to nose average (10s before loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_to_nose_distance",
                "window": {
        ...
        "Nose to nose average (10s after nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_to_nose_distance",
                "window": {
        ...
        # =====================================================================
        # NOSE-TO-TAIL DISTANCE FEATURES (Social/Pair)
        # =====================================================================

        "Nose1 to tail2 average (during loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_1_to_tail_2_distance",
                "window": {
                    "frame_start_point": "loomtime",
                    "frame_end_offset": int(7.5 * fps)
                },
        ...
        "Nose1 to tail2 average (start loom - nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_1_to_tail_2_distance",
                "window": {
        ...
        "Nose1 to tail2 average (10s before loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_1_to_tail_2_distance",
                "window": {
        ...
        "Nose1 to tail2 average (10s after nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_1_to_tail_2_distance",
                "window": {
        ...
        "Nose2 to tail1 average (during loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_2_to_tail_1_distance",
                "window": {
                    "frame_start_point": "loomtime",
                    "frame_end_offset": int(7.5 * fps)
                },
        ...
        "Nose2 to tail1 average (start loom - nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_2_to_tail_1_distance",
                "window": {
        ...
        "Nose2 to tail1 average (10s before loom)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_2_to_tail_1_distance",
                "window": {
        ...
        "Nose2 to tail1 average (10s after nest entry)": {
            "func": "feature_post_loom_average",
            "kwargs": {
                "feature": "nose_2_to_tail_1_distance",
                "window": {
...
if __name__ == "__main__":
    ...
    config = build_calculated_features(DEFAULT_FPS, DEFAULT_PIXELS_PER_CM)
    print(f"Defined {len(config)} features:")
    for name in config:
        print(f"  - {name}")
